...
exports.auth0GetRole = void 0;
var _1 = require(".");
var loggers_1 = require("../../utils/loggers");
function auth0GetRole(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, _1.auth0BaseClient.get("/api/v2/users/" + id + "/roles")];
                case 1:
                    result = _a.sent();
                    loggers_1.logger.debug(result.data);
...
exports.auth0GetRole = auth0GetRole;
