...
exports.User = User;
function auth0CreateNewUser(newUser) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, _1.auth0BaseClient.post('/api/v2/users', body)];
                case 1:
                    res = _a.sent();
                    return [4 /*yield*/, _1.auth0BaseClient.post("/api/v2/users/" + res.data.user_id + "/roles", {
                            roles: [
                ...
                case 2:
                    _a.sent();
                    return [2 /*return*/, res.data.user_id];
                case 3:
                    e_1 = _a.sent();
...
exports.auth0CreateNewUser = auth0CreateNewUser;
